Feature: Testing functionalities on the Home Page
  ...
  Background: 
    Given User opens browser "FireFox" and navigate to the Home Page
  ...
  Scenario: Verify Test3 functionality
    ...
    Then option "Option 1" should be the default selected value
    When User select option3 from the dropdown
    Then option "Option 3" should be the selected value in the dropdown
